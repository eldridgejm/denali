    ...
    namespace concepts {
        ...
        */
        ...
        public:
            ...
            bool isNodeValid(Node) const { return true; }
        ...
        public:
            ...
            bool isArcValid(Arc) const { return true; }
        ...
        public:
            ...
            bool isEdgeValid(Edge) const { return true; }
        ...
        public:
            ...
            /// Gets the first out arc of a node.
            Arc getFirstOutArc(Node) const { return Arc(); }

            /// \brief Gets the next out arc of the node which is the source of the 
            /// passed arc.
            Arc getNextOutArc(Arc) const { return Arc(); }

            /// \brief Get the target of the arc.
            /// \pre The arc must be valid.
            Node target(Arc) const { return Node(); }
        ...
        public:
            ...
            Arc getFirstNeighborArc(Node) const { return Arc(); }

            /// Gets the next neighbor arc attached to the node.
            Arc getNextNeighborArc(Node, Arc) const { return Arc(); }

            /// \brief Get the opposite node of the arc.
            /// \pre The node must be in the arc.
            Node opposite(Node, Arc) const { return Node(); }
        ...
        public:
            ...
            Edge getFirstNeighborEdge(Node) const { return Edge(); }

            /// Gets the next neighbor edge attached to the node.
            Edge getNextNeighborEdge(Node, Edge) const { return Edge(); }

            /// \brief Get the opposite node of the edge.
            /// \pre The node must be in the edge.
            Node opposite(Node, Edge) const { return Node(); }
        ...
        public:
            ...
            unsigned int getMaxNodeIdentifier() const { return 0; }

            /// \brief Get the identifier of the node.
            unsigned int getNodeIdentifier(Node) const { return 0; }
        ...
        public:
            ...
            unsigned int getMaxArcIdentifier() const { return 0; }

            /// \brief Get the identifier of the arc.
            unsigned int getArcIdentifier(Arc) const { return 0; }
        ...
        public:
            ...
            unsigned int getMaxEdgeIdentifier() const { return 0; }

            /// \brief Get the identifier of the edge.
            unsigned int getEdgeIdentifier(Edge) const { return 0; }
        ...
        */
        ...
        public:
            ...
            unsigned int degree(Node) const { return 0; }

            /// \brief Get the in degree of the node.
            /// \pre The node must be valid.
            unsigned int inDegree(Node) const { return 0; }

            /// \brief Get the out degree of the node.
            /// \pre The node must be valid.
            unsigned int outDegree(Node) const { return 0; }

            /// \brief The number of nodes in the graph
            unsigned int numberOfNodes() const { return 0; }

            /// \brief The number of arcs in the graph
            unsigned int numberOfArcs() const { return 0; }
        ...
        */
        ...
        public:
            ...
            Node u(Edge) const { return Node(); }

            /// \brief Gets the "v" node at the end of an edge.
            /// \pre The edge must be valid.
            Node v(Edge) const { return Node(); }
        ...
        public:
            ...
            /// \brief Add a node to the graph
            Node addNode() { return Node(); }

            /// \brief Add an edge to the graph
            /// \pre Both nodes must be in the graph.
            Edge addEdge(Node, Node) { return Edge(); }
