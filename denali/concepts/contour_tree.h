...
namespace denali {
    namespace concepts {
        ...
        class ScalarSimplicialComplex : public concepts::ReadableUndirectedGraph
        {
            ...
            double getValue(Node node) const { return 0.0; }
        ...
        class ContourTree : public concepts::ReadableUndirectedGraph
        {
            ...
            double getValue(Node node) { return 0.; }

            /// \brief Get a node's ID
            unsigned int getID(Node node) { return 0; }
        ...
        class UndirectedScalarMemberIDGraph : public concepts::ReadableUndirectedGraph
        {
             ...
             */
            Node addNode(unsigned int id, double value) { Node(); }

            /// \brief Add an edge to the graph.
            Edge addEdge(Node u, Node v) { Edge(); }
        ...
        class RandomAccessComparisonFunctor
        {
            ...
            bool operator()(unsigned int u, unsigned int v) { return true; }
        ...
        class TotalOrder
        {
            ...
            unsigned int positionToElement(unsigned int index) const { return 0; }

            /// \brief Retrieve the element at this position in the ordering.
            unsigned int elementToPosition(unsigned int index) const { return 0; }
