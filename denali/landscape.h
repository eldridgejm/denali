...
namespace denali {
    ...
    public:
        ...
        Node getRoot() const { return _tree.getRoot(); }
    ...
    public:
        ...
        double getTotalNodeWeight(Node node) const { return _node_to_total_weight[node]; }

        /// \brief Get the weight of the node.
        double getNodeWeight(Node node) const { return _node_to_weight[node]; }

        /// \brief Get the weight of the arc.
        double getArcWeight(Arc arc) const { return _arc_to_weight[arc]; }
